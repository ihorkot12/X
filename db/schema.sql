...
CREATE INDEX IF NOT EXISTS bbp_athletes_owner_idx ON bbp_athletes(owner_id);
CREATE INDEX IF NOT EXISTS bbp_programs_owner_idx ON bbp_programs(owner_id, saved_at DESC);
CREATE INDEX IF NOT EXISTS bbp_logs_owner_idx ON bbp_training_logs(owner_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS bbp_teams_owner_idx ON bbp_teams(owner_id);
CREATE INDEX IF NOT EXISTS bbp_memberships_coach_idx ON bbp_team_memberships(coach_id);
CREATE INDEX IF NOT EXISTS bbp_memberships_athlete_idx ON bbp_team_memberships(athlete_account_id);
CREATE INDEX IF NOT EXISTS bbp_test_history_owner_idx ON bbp_test_history(owner_id, test_date DESC);
